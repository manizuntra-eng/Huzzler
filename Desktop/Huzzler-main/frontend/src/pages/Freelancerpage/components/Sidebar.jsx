      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-top">
          ...
          <div className="logo-box">
            <div className="logo-title">HUZZLER rr</div>
          ...
          <nav className="nav">
            ...
            {/* HOME */}
            <button className="nav-btn" onClick={() => navigate("/freelance-dashboard")}>
              <Home size={18} /> Home
            </button>

            {/* BROWSE PROJECTS */}
            <button className="nav-btn" onClick={() => navigate("/freelance-dashboard/categories")}>
            ...
            {/* PROFILE */}
            <button className="nav-btn" onClick={() => navigate("/freelance-dashboard/Profilebuilder")}>
              <User size={18} /> Profile
            </button>

            {/* SETTINGS */}
            <button className="nav-btn" onClick={() => navigate("/freelance-dashboard/settings")}>
