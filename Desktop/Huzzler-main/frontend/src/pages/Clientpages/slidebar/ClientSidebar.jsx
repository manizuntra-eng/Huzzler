      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-top">
          ...
          <nav className="nav">
            ...
            {/* HOME */}
            <button className="nav-btn" onClick={() => navigate("/client-dashbroad2")}>
              <Home size={18} /> Home
            </button>
            ...
            <button className="nav-btn" onClick={() => navigate("/myjobs")}>
             ...
             <button className="nav-btn" onClick={() => navigate("/client-dashbroad2/clientservicelistpage")}>
              <Briefcase size={18} /> My service
            </button>

            {/* PROFILE */}
            <button className="nav-btn" onClick={() => navigate("/client-dashbroad2/Profilebuilder")}>
