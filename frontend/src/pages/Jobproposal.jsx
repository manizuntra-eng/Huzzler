...
export default function JobProposal() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      FreelancerRequirement:activeTab === "work" ? "Looking for a skilled freelancer" : "Quick 24-hour turnaround project",
    };

    try {
      const res = await axios.post("http://localhost:5000/api/jobProposal/createJobProposal",
        payload,
        {
